...
public class OutputWriter {
	...
	public static void reverse() {
		...
		Collections.reverse(row9);
		Collections.reverse(row10);
		Collections.reverse(row11);
		Collections.reverse(row12);
		Collections.reverse(row13);
		Collections.reverse(row14);
		Collections.reverse(row15);
		Collections.reverse(row16);
		Collections.reverse(row17);
		Collections.reverse(row18);
		Collections.reverse(row19);
